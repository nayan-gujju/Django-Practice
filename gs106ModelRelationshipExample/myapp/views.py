...
def show_user_data(request):
  ...
  data2 = User.objects.filter(email='meet@gmail.com')
  data3 = User.objects.filter(mypage__page_cat='React Js Programming')
  data4 = User.objects.filter(mypost__post_publish_date='2021-08-17')
...
def show_page_data(request):
  ...
  data2 = Page.objects.filter(page_cat='Django Programming')
  data3 = Page.objects.filter(user__email='meet@gmail.com')
...
def show_post_data(request):
  ...
  data2 = Post.objects.filter(post_publish_date='2021-08-17')
  data3 = Post.objects.filter(user__username='nayan')
...
def show_song_data(request):
  ...
  data2 = Song.objects.filter(song_duration=8)
  data3 = Song.objects.filter(user__username='arp')
